...
with Browser ID just like on the live site.

If, however, you don't have Persona/Browser ID enabled on your site, you can
register a new user "the old way" by filling in the registration form. Remember
to activate this user using the link in the confirmation email sent: it's
